...
public class Message implements Comparable<Message> {
	...
	private DTNHost from;						//源地址
	private DTNHost to;							//目的地址
	/** Identifier of the message */
	private String id;							//消息ID
	/** Size of the message (bytes) */
	private int size;							// 消息尺寸
