 ...
 */
public class MessageEventResponsedGenerator implements EventQueue {
    /**
     ...
     */
    public MessageEventResponsedGenerator(Settings s) {
    ...
    public ExternalEvent nextEvent() {
        int responseSize = 2000; /* zero stands for one way messages */
        int msgSize=1000;
        int interval;
        int from;
        int to;
        ...
        from = drawHostAddress(this.hostRange);    //随机挑选
